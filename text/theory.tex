...
However, it also demonstrates that the law is by no means exact and that some greyness
\marknote{uncertainty?} is inevitably introduced during the linear regression.
\marknote{Do you discuss this problem elsewhere? If not, perhaps make more of it here?}

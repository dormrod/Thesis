...
In the physical sciences, random tessellations are not restricted to atomic materials, but are observed in foams \cite{Durand2011,Tong2017,Noever1992}, crack\--patterns  (in dessicated films, ceramics \etc), as well as in colloidal films through the Voronoi construction \-- to name a few \cite{Ma2019,Earnshaw1994,Allain1995,Moncho-Jorda2000}.
...
Chapters \ref{ch:bilayers} and \ref{ch:targetedopt} of this thesis focussed on planar atomic systems which had a fixed coordination of three.

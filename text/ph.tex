...
However, this can be achieved with another algorithm developed in this thesis, namely bond switching \davidnote{link}.
...
The specific systems studied will be a subset of those from chapter \davidnote{link}, namely those at two different bond stretching and angle force constant ratios of $k_r/t_\theta=16,4$, with convexity maintained.
...
\begin{figure}[tbp]
	\centering
      ...
      \begin{subfigure}[b]{0.40\textwidth}
         ...
         \caption{$k_r/k_\theta=16$, $p_6=0.890$} %399
         \label{fig:bspda}
     \end{subfigure}
     \hspace{2cm}
        \begin{subfigure}[b]{0.40\textwidth}
         ...
         \caption{$k_r/k_\theta=16$, $p_6=0.666$}% 301
         \label{fig:bspdb}
     \end{subfigure}
        ...
        \begin{subfigure}[b]{0.40\textwidth}
         ...
         \caption{$k_r/k_\theta=16$, $p_6=0.332$}% 231
         \label{fig:bspdc}
     \end{subfigure}
     \hspace{2cm}
      \begin{subfigure}[b]{0.40\textwidth}
         ...
         \caption{$k_r/k_\theta=16$, $p_6=0.164$}% 0
         \label{fig:bspdd}
     \end{subfigure}
	...
	\begin{subfigure}[b]{0.40\textwidth}
         ...
         \caption{$k_r/k_\theta=4$, $p_6=0.943$}% 399
         \label{fig:bspde}
     \end{subfigure}
     \hspace{2cm}
        \begin{subfigure}[b]{0.40\textwidth}
         ...
         \caption{$k_r/k_\theta=4$, $p_6=0.662$}% 257
         \label{fig:bspdf}
     \end{subfigure}
        ...
        \begin{subfigure}[b]{0.40\textwidth}
         ...
         \caption{$k_r/k_\theta=4$, $p_6=0.332$}% 189
         \label{fig:bspdg}
     \end{subfigure}
     \hspace{2cm}
      \begin{subfigure}[b]{0.40\textwidth}
         ...
         \caption{$k_r/k_\theta=4$, $p_6=0.163$}% 0}
         \label{fig:bspdh}
     \end{subfigure}
...
As mentioned for the corresponding persistence diagrams, this results from the large variation in bond length and angle distributions \davidnote{Would it be useful to include histograms of the bond lengths/angles in all this discussion?}.

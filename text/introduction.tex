...
In response to the second question, the power of computational modelling as a  complement to experiment arises not only from the ability to reproduce experimental results, but also from the potential to perform idealised experiments \textit{in silico}.% and explore experimentally inaccessible systems.

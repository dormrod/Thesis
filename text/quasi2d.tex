...
This is because......Local measure? \davidnote{Mark?}
...
\davidnote{Check all this with Mark}
...
\davidnote{Come up with a satisfactory relative model for this? Perhaps I have a semi-decent one somewhere...Nope, don't think so.} 
...
Similar trends were in fact seen for x-rings in triangle rafts in section \davidnote{ref}. 
...
\begin{figure}[bt]
     ...
     \label{fig:bime}
\end{figure}
\davidnote{Is this figure clear or confusing?} 
...
The motivation for this is that up to this point, it has merely been stated that the unweighted 2D Voronoi is an appropriate construction (as opposed to a weighted variant - see section \davidnote{link}), even for collections of particles of varying radii.
...
As previously alluded to in section \davidnote{link}, a weighted Voronoi construction is required in this case, to avoid the possibility of the polyhedra cutting through the larger particles.
...
\davidnote{Revisit Voronoi section in methods. Introduce weighted Voronoi there or here?}

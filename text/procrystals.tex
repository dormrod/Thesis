...
\begin{enumerate}
	\item Initialise the required $c^\prime$\--coordinate periodic lattice from figure \ref{fig:symlat} and assign bonds randonly to each node $c$. This will introduce a number of dangling bonds into the configuration.

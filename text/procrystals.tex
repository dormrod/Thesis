...
Most dramatically, the smallest \pro{4}{3}trihexagonal system (containing 12 vertices as shown in figure \ref{fig:trihex}) is unable to sustain a $6$\-- or $9$\--membered ring whilst maintaining full $3-$coordination, in contrast to larger lattice dimensions.
...
To investigate this, figures \ref{fig:pro3p6ssmu2},\ref{fig:pro3p6ssr} shows the evolution of $\mu_2$ and $r$ as a function of system size (as characterised
...
The \pro{5}{3}elongated\--triangular procrystal contains alternating chains of percolating squares and triangles the the former again preferentially promoting the formation of more linear rings (evident `by eye' in figure \ref{fig:pro3c}).
...
From equation \davidnote{ref}, these systems will have mean ring sizes of $\ki=4$ and $\ki=\frac{4}{3}$ respectively.
Again the Monte Carlo method in section \davidnote{ref} was used to generate 100,000 periodic samples of these procrystals, across a range of system sizes.
...
In terms of \lm's law, the discrepancy between the random limit and the procrystals is increased as the number of constraints increases. 
...
Hence the \pro{5}{4}snub\--square lattice has quite a tight distribution (similar to the \pro{4}{3}trihexagonal case), with the \pro{5}{4}elongated triangular procrystal points being much more diffuse.
...
In particular, the ring statistics are largely constant, even for procrystals in which the maximum ring size continues to grow with the lattice dimension \ie \pro{5}{4}elongated\--triangular and \pro{6}{4}triangular.
